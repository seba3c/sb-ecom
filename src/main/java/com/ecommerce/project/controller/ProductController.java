...
public class ProductController {
  ...
  public ResponseEntity<ProductListResponse> getAllProducts(
      @RequestParam(defaultValue = AppConfig.Pagination.PAGE_NUMBER, required = false)
          Integer pageNumber,
      @RequestParam(defaultValue = AppConfig.Pagination.PAGE_SIZE, required = false)
          Integer pageSize,
      @RequestParam(defaultValue = AppConfig.Pagination.SORT_PRODUCTS_BY, required = false)
          String sortBy,
      @RequestParam(defaultValue = AppConfig.Pagination.SORT_PRODUCTS_DIR, required = false)
          String sortOrder) {
