...
public class ProductServiceImpl implements ProductService {
  ...
  public ProductListResponse getAllProducts(
    ...
    return toProductListResponse(
        productRepository.findAll(toPageable(pageNumber, pageSize, sortBy, sortOrder)));
  }
  ...
  public ProductListResponse getProductsByCategory(
    ...
    Page<Product> page =
        productRepository.findByCategory(
            category, toPageable(pageNumber, pageSize, sortBy, sortOrder));
    return toProductListResponse(page);
  }
  ...
  private ProductListResponse toProductListResponse(Page<Product> page) {
    List<ProductDetailResponse> dtos =
