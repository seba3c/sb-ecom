...
class WithUserDetailsImplSecurityContextFactory
    implements WithSecurityContextFactory<WithUserDetailsImpl> {
  @Override
  public org.springframework.security.core.context.SecurityContext createSecurityContext(
    ...
    List<SimpleGrantedAuthority> authorities =
        java.util.Arrays.stream(annotation.roles())
...
class AuthControllerTest {
  ...
  void signin_validCredentials_returns200WithCookieAndUserInfo() throws Exception {
    ...
    ResponseCookie jwtCookie =
        ResponseCookie.from("ecommerce-app", "jwt-token-here").path("/api").maxAge(86400).build();
