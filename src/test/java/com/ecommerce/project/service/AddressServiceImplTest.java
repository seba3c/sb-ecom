...
class AddressServiceImplTest {
  ...
  void createAddress_success() {
    ...
    AddressCreateRequest request =
        new AddressCreateRequest("123 Main St", null, "New York", "NY", "USA", "10001");
  ...
  void updateAddress_success() {
    ...
    AddressUpdateRequest request =
        new AddressUpdateRequest("Updated St", null, "Boston", "MA", "USA", "02101");
  ...
  void updateAddress_notFound_throwsResourceNotFoundException() {
    ...
    assertThrows(
        ResourceNotFoundException.class, () -> addressService.updateAddress(1L, 99L, request));
  }
